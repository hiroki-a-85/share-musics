...
@section('content')
    <div class="top-wrapper col-sm-10 offset-sm-1 mb-3">
        <p class="title">お気に入りの音楽を共有</p>
        <p class="title">新しい音楽の発見</p>
        @if (Auth::check())
        @else
            <div class="d-flex justify-content-center mt-3">
                {!! link_to_route('signup.get', 'アカウントを作る', [], ['class' => 'topwrapper_btn btn btn-primary d-inline-block mr-3']) !!}
                {!! link_to_route('login', 'ログイン', [], ['class' => 'topwrapper_btn btn btn-primary d-inline-block pl-4 pr-4 ml-3']) !!}
            </div>
        @endif
    </div>
    ...
    <div class="container mb-4">
       <div class="row">
           ...
           <div id="search_area" class="col-sm-5 offset-sm-1 bg-light pt-3">
                <p>作品を探す</p>
                <hr>
